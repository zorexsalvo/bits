...
urlpatterns = [
    ...
    url(r'update_employee/(?P<employee_id>\d+)/$', login_required(UpdateEmployee.as_view()), name='update_employee'),
    url(r'delete_employee/(?P<employee_id>\d+)/$', login_required(DeleteEmployee.as_view()), name='update_employee'),
